 ...
 */
    ...
    /**
     * Set the value for IsSellerImporterOfRecord
     *
     * @param boolean $value
     * @return $this
     */
 ...
 */
    ...
    public function getAddresses() 
	{
		...
		return is_array($this->Addresses) ? $this->Addresses : Utils::EnsureIsArray($this->Addresses->BaseAddress);
    ...
    {
	return is_array($this->Lines) ? $this->Lines : Utils::EnsureIsArray($this->Lines->Line);
     }					//array
